...
$("#response").load("<?php $actual_link = 'http'.(isset($_SERVER['HTTPS']) ? 's' : '').'://'."{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}"; echo '//belowaverage.ga/PhoneHome/index.php?url='.$actual_link.'&version='.$version.'&product=Who\'s%20Online'; ?>");
});
</script>
</body>
</html>